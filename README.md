...
* Skip-to-tick functionality for targeted parsing - [docs](https://pkg.go.dev/github.com/markus-wa/demoinfocs-golang/v5/pkg/demoinfocs?tab=doc#ParserConfig) / [example](https://github.com/markus-wa/demoinfocs-golang/tree/master/examples/skip-to-tick)
